...
export default function HomePage() {
  ...
  return (
    <>
      <div className="fixed top-0 left-0 w-full h-full bg-gradient-to-br from-black via-gray-900 to-black z-[-1]" />

      <div
        className={`bg-background text-foreground py-12 px-4 flex flex-col items-center space-y-10 min-h-screen ${getThemeClass(
          selectedCancer
        )}`}
      >
        <AnimatePresence mode="wait">
          <motion.h1
            ...
            className="text-6xl font-bold text-center text-white drop-shadow-lg"
          >
            OmniScan <span className="text-blue-500">\uD83D\uDD2C</span>
          </motion.h1>
        </AnimatePresence>
        ...
        >
          <Card className="bg-card text-card-foreground shadow-lg transition-all duration-300 hover:scale-[1.02]">
            <CardContent className="text-center space-y-4">
              ...
              <CardDescription>
                Upload an endoscopic image and let our CNN model highlight suspicious regions in seconds.
              </CardDescription>
            </CardContent>
          </Card>
